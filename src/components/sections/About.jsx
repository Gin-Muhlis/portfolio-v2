...
const About = () => {
    return (
        <Container>
            <div className="w-full block md:flex items-center justify-between py-16 md:py-0">
                ...
                <div>
                    <h2 className='text-primary font-bold mb-4 text-4xl'>Who am I?</h2>
                    <p className='text-sm text-slate-100 leading-8 mb-7'>A graduate of a Vocational High School (SMK) majoring in Software Engineering, with over 3 years of learning
                    ...
                    <div className="w-full font-bold flex items-center justify-start gap-5 flex-wrap">
