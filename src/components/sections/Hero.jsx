...
const Hero = () => {
    return (
        <Container>
            <div className=" w-full block md:flex items-center justify-between gap-10 py-16 md:py-44 relative" id='hero'>
                ...
                <div className='flex-1 flex items-center justify-center md:justify-end'>
                    <div className="relative md:-translate-y-16">
                        ...
                        <img src="/assets/images/html.png" alt="Image Me" className='object-cover absolute -left-16 bottom-12 w-12 md:w-16' />
                        <img src="/assets/images/css.png" alt="Image Me" className='object-cover absolute -left-16 -bottom-20 w-12 md:w-16 ' />
                        <img src="/assets/images/js.png" alt="Image Me" className='object-cover absolute left-16 -bottom-24 w-12 md:w-16' />
                    </div>
                </div>
            </div>
